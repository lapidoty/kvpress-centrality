...
| [`reproduction/`](reproduction/) | how to benchmark — one command ([`scripts/benchmark.py`](reproduction/scripts/benchmark.py)), `Dockerfile` + `requirements.txt`, and the committed RULER results (sample logs, traceable to their run directories) |
