#!/bin/bash
# Qwen3-8B board grid: centrality_ppr_knorm, ruler/4096, FULL fraction, flash_attention_2 (auto-selected
# when flash-attn is installed). Override via env: MODEL, OUT, PYTHON.
