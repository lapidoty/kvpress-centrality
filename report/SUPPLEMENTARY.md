...
- **Benchmark + analysis (`Appendix/`):** `scripts/ruler_rerun.py`, `scripts/sweep_longbench.py`,
...
- **Data/logs (`Appendix/results/`):** `board_grid/`, `ruler_screen/`, and `ablations/` run directories
